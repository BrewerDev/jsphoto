...
<div id="nav_main">
        ...
        <div id="lnk_events" class="button">
        		<p id="evnt_arrow" class="arrow"><img src="images/arrow_3.gif" width="11" height="11" alt="extend gallery list" /></p>
            	<p id="evnt_lnk" class="link"><a href="#" id="k">Events</a></p>
       	</div><!--lnk_events-->
        
        <div id="list_1" class="closed">
			<?php
        ...
        <div id="lnk_gal" class="button">
            <p id="gal_arrow" class="arrow"><img src="images/arrow_3.gif" width="11" height="11" alt="extend gallery list" /></p>
           	<p id="gal_lnk" class="link"><a href="pict_gallerys.php">Gallerys</a></p>
		</div><!--lnk_gal-->
            
        <div id="list_2" class="closed">
			<?php
				$db = mysql_connect( 'localhost', 'pb0612_admin', '562288');//connect to server
				mysql_select_db('pb0612_josh', $db);// select database
        ...
        <div id="lnk_vid" class="button">
            <p id="vid_arrow" class="arrow"><img src="images/arrow_3.gif" width="11" height="11" alt="extend video list" /></p>
           	<p id="vid_lnk" class="link"><a href="#">Videos</a></p>
       	</div><!--lnk_vid-->
