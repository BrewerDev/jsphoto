...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Joshua Smith Film and Photography - Photo Galleries</title>
							...
							<?php
								...
								while($row = mysql_fetch_array($result))// Loops untill the end of the array
								{
									echo 	"<div class='gallery'>
													<a href='pict_gallery.php?gallery=".$row['gallery_id']."&title=".$row['gallery_title']."'><h2 class='title_bar'>".$row['gallery_title']."</h2></a>
													<p class='thumbnail'><a href='pict_gallery.php?gallery=".$row['gallery_id']."&title=".$row['gallery_title']."'><img src='".$row['thumb']."' class='thumbnail'/></a></p>
													<p class=''>".$row['gallery_discription']."</p>
												</div>";
								}
							?>
							</div><!--boundary_box-->
